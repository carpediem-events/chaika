...
const PATHS: Record<Kind, { d: string; box: string; head?: string }> = {
  // Вершина острия в точке (11,138) — ровно там, где заканчивается линия,
  // и раскрыто по её касательной. Обратного завитка на конце нет: он разворачивал
  // линию поперёк острия, и стрелка читалась как галочка.
  'arrow-down': {
    box: '0 0 90 142',
    d: 'M74 8c8 32 2 57-16 74-13 12-29 20-38 35-4 6-7 13-9 21',
    head: 'M6 123l5 15 13-12',
  },
  // то же правило: вершина (154,32) совпадает с концом линии
  'arrow-right': {
    box: '0 0 160 70',
    d: 'M6 22c30-18 66-20 98-6 15 7 30 18 50 16',
    head: 'M138 25l16 7-16 12',
  },
  circle: {
    box: '0 0 220 90',
