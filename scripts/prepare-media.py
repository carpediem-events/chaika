...
JOBS = [
    ...
    # лента «Наши встречи» — порядок и подписи заданы в src/content.ts
    ("IMG_6415.JPG", "ev-1.jpg", 1300),     # звукотерапия и творчество
    ("IMG_6422.JPG", "ev-2.jpg", 1300),     # арт-терапия
    ("IMG_6426.PNG", "ev-3.jpg", 1300),     # актёрский мастер-класс
    ("IMG_6416.JPG", "ev-4.jpg", 1300),     # день йоги
    ("IMG_6317.JPG", "ev-5.jpg", 1300),     # расстановки
]
